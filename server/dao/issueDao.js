...
/**
 * 根据 userId 删除这个用户的所有问答
 */
module.exports.deleteIssuesByUserIdDao = async function (id) {
...
/**
 * 根据 typeId 删除这个类型的所有问答
 */
module.exports.deleteIssuesByTypeIdDao = async function (id) {
  const issues = await issueModel.find({
    typeId: id,
  })
  await issueModel.deleteMany({
