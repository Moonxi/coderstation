...
/**
 * 根据 userId 删除这个用户的所有评论
 */
module.exports.deleteCommentsByUserIdDao = async function (id) {
...
/**
 * 根据 issueId 删除这个问答的所有评论
 */
module.exports.deleteCommentsByIssueIdDao = async function (id) {
  return commentModel.deleteMany({
    issueId: id,
  });
};
...
/**
 * 根据 bookId 删除这本书籍的所有评论
 */
module.exports.deleteCommentsByBookIdDao = async function (id) {
  return commentModel.deleteMany({
    bookId: id,
  });
};
...
/**
 * 根据 issueId 获取该问答下评论总条数
 */
module.exports.getCommentsCountByIssueIdDao = async function (id) {
...
/**
 * 根据 bookId 获取该书籍下评论总条数
 */
module.exports.getCommentsCountByBookIdDao = async function (id) {
  return commentModel.countDocuments({
    bookId: id,
  });
};